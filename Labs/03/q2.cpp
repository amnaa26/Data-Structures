 ...
 * Date: 2/Sept/2024
 * Desc: Write a function to reverse the singly linked list.
*/
...
public:
	...
	void reverse(){
		Node* previous = NULL; //previous is our tail which is the old head
		Node* current = head; //current starts as head
		Node* next = NULL; //use to store the next node
